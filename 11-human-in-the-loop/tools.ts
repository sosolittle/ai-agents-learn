...
//
//  🏠 生活化比喻：审批处后屋的「业务窗口」。窗口里的办事员
//  只管按单办事——单上说退 49 欧就退 49 欧，他不知道也不关心
//  这张单过没过审批（那是前面窗口的事），他桌上甚至没有
//  《权限表》的复印件。最里头还有一个上了锁的空窗口
//  （deleteProductionUsers）：牌子还挂着，玻璃后面根本没有人——
//  这是最彻底的安全：连"办事的代码"都不存在。
//
//  学习目标：
