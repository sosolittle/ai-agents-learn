// ============================================================
//  index_original.ts —— error-handling-retries 的「原始参考版」
//
//  与 index.ts 的关系：
//  本文件整体被注释保存，是最初的英文日志版；index.ts 是它的中文
//  日志/提示词版（错误类型标签从 rate_limit 改成「请求限流」等），
//  重试逻辑完全相同：前两次模拟 429/500，指数退避 + jitter，最多 4 次。
// ============================================================
//
// // ============================================================
