// ============================================================
//  index_original.ts —— agent-loop 的「原始参考版」
//
//  与 index.ts 的关系：
//  本文件整体被注释保存，是第三章最初的版本；index.ts 是在它
//  基础上做的中文化升级（system 提示词、工具 description、报错
//  文案、控制台输出全部改成中文），agent 循环逻辑完全相同：
//  MAX_ITERATIONS 保险丝 + 两个出口（finish_reason "stop" /
//  write_report 终止工具）。学习时看注释最全的 index.ts 即可，
//  本文件留着对照「英文原版长什么样」。
// ============================================================
//
// // ============================================================
